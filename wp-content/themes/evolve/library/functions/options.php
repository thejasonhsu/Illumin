...
"type" => "typography",
"std" => array('size' => '39px', 'face' => 'Archer SSm A' ,'style' => 'bold','color' => '')
);
...
"type" => "typography",
"std" => array('size' => '13px', 'face' => 'Archer SSm A','style' => 'normal','color' => '')
);
...
"type" => "typography",
"std" => array('size' => '14px', 'face' => 'Archer SSm A','style' => 'normal','color' => '')
);
...
"type" => "typography",
"std" => array('size' => '28px', 'face' => 'Archer SSm A','style' => 'normal','color' => '')
);
...
"type" => "typography",
"std" => array('size' => '16px', 'face' => 'Archer SSm A','style' => 'normal','color' => '')
);
...
"id" => $evolve_shortname."_heading_font",
"type" => "typography",
"std" => array('size' => 'none', 'face' => 'Archer SSm A','style' => 'normal','color' => '')
);
...
$options['evl_header_footer_back_color'] = array( "name" => __( 'Header and Footer color', 'evolve' ),
"desc" => __( 'Custom background color of header and footer', 'evolve' ),
...
"type" => "typography",
"std" => array('size' => '36px', 'face' => 'Archer SSm A','style' => 'normal','color' => '')
);
...
"type" => "typography",
"std" => array('size' => '18px', 'face' => 'Archer SSm A','style' => 'normal','color' => '')
);
...
$options['evl_bootstrap_slide1_author'] = array( "name" => __( 'Slide 1 Author', 'evolve' ),
"desc" => "",
"id" => $evolve_shortname."_bootstrap_slide1_author",
"type" => "text",
"class" => "hidden",
"std" => __( 'Kelsey Rose', 'evolve' ));
...
$options['evl_bootstrap_slide2_author'] = array( "name" => __( 'Slide 2 Author', 'evolve' ),
"desc" => "",
"id" => $evolve_shortname."_bootstrap_slide2_author",
"type" => "text",
"class" => "hidden",
"std" => __( 'Kelsey Rose', 'evolve' ));
...
$options['evl_bootstrap_slide3_author'] = array( "name" => __( 'Slide 3 Author', 'evolve' ),
"desc" => "",
"id" => $evolve_shortname."_bootstrap_slide3_author",
"type" => "text",
"class" => "hidden",
"std" => __( 'Kelsey Rose', 'evolve' ));
...
$options['evl_bootstrap_slide4_author'] = array( "name" => __( 'Slide 4 Author', 'evolve' ),
"desc" => "",
"id" => $evolve_shortname."_bootstrap_slide4_author",
"type" => "text",
"class" => "hidden",
"std" => __( 'Kelsey Rose', 'evolve' ));
...
$options['evl_bootstrap_slide5_author'] = array( "name" => __( 'Slide 5 Author', 'evolve' ),
"desc" => "",
"id" => $evolve_shortname."_bootstrap_slide5_author",
"type" => "text",
"class" => "hidden",
"std" => __( 'Kelsey Rose', 'evolve' ));
