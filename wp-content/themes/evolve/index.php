...
<div class="entry-caption"><?php if ( !empty( $post->post_excerpt ) ) the_excerpt(); ?></div>
 ...
 <?php if ( have_posts() ) : ?>
        ...
        { ?>  <h1 class="entry-title"><?php if ( get_the_title() ){ the_title(); } ?></h1>
					...
					<!--BEGIN .entry-meta .entry-header-->
					<div class="entry-meta entry-header">
          <span class="published updated"><?php the_time(get_option('date_format')); ?></span>
          ...
          <strong><?php printf(get_the_author()) ?> </strong></span>
...
echo evolve_truncate($title, $evolve_posts_excerpt_title_length, '...'); } ?></a>  
          ...
          <?php _e( 'Written by', 'evolve' ); ?> <strong>

          <?php printf(get_the_author()) ?></strong></span>
