...
'
    ...
    function license_notice()
    {
        if (true) {
            ...
            echo 'Your License is inactive, please <a href="' . $this->get_renewal_link() . '">activate your product license</a>.';
            echo '</div>';
        }
    }
    ...
    function license_menu()
    {
        ...
        add_submenu_page(
            'wpzoom_options',
            __('Getting Started', 'wpzoom'),//$strings['theme-license'],
            __('Getting Started', 'wpzoom'),//$strings['theme-license'],
            'manage_options',
            'wpzoom-license',
    ...
    function license_page()
    {
        ...
        <div class="cols-wrap">
            ...
            <div class="wpz_right-col">
                ...
                <?php /* <div class="license-wrap">

                    <h2 class="headline"><?php _e( 'Activate Your License Key', 'wpzoom' ); ?></h2>

                    <p>
                        <?php echo sprintf( __( 'Enter your license key to enable <strong>automatic theme updates</strong>. You can find your license in <a href="https://www.wpzoom.com/members/">WPZOOM Member Area</a>.', 'wpzoom' ) );
                         ?>
                    </p>
            ...
            <div class="theme-guide">
                ...
                <h2 class="headline"><?php echo sprintf(__('Getting Started with %s', 'wpzoom'), WPZOOM::$themeName); ?></h2>
                    ...
                    <ol>
                        ...
                        <li>
                            <?php if (!empty($guide_line['header'])): ?>
                                <h3><?php echo $guide_line['header'] ?></h3>
                            <?php endif; ?>
                            <?php if (!empty($guide_line['content'])): ?>
                                <p><?php echo $guide_line['content'] ?></p>
                            <?php endif; ?>
