...
$evolve_css_data .= '
.header, .footer {background:'.$evolve_custom_main_color.';}
';
...
if (!is_array($blog_title)){
  ...
  //evolve_get_option('evl_title_font')=$blog_title;
}
...
if ($content_font) {
 $evolve_css_data .= 'body, input, textarea, .entry-content {font-style:' . $content_font['style'] . '; font-size:' .$content_font['size'] . '!important; font-family:' . $content_font['face']. '; color:'.$content_font['color'].';line-height:1.5em;}
...
if ($bootstrap_100_background == '1') {} else {
$evolve_css_data .= '#bootstrap-slider .carousel-inner .img-responsive {display: block;height: auto;width: 100%;}';
} 
 
$bootstrap_slide_title = evolve_get_option('evl_bootstrap_slide_title_font');
...
$bootstrap_slide_desc = evolve_get_option('evl_bootstrap_slide_desc_font');
...
$parallax_slide_title = evolve_get_option('evl_parallax_slide_title_font');
...
$parallax_slide_desc = evolve_get_option('evl_parallax_slide_desc_font');
...
$carousel_slide_title = evolve_get_option('evl_carousel_slide_title_font');
...
$carousel_slide_desc = evolve_get_option('evl_carousel_slide_desc_font');
...
if( get_header_image() ) {   
$evolve_css_data .= '.header {padding:0;} .custom-header {padding:40px 20px 5px 20px!important;min-height:125px;background:url('.get_header_image().') top center no-repeat;border-bottom:0;background-size:'.$evolve_header_image.'!important;width:100%;}';

if ($evolve_width_layout == "fluid") { 
$evolve_css_data .= '.header {padding:0;} .custom-header {padding:40px 0px 5px 0px!important;position:relative;min-height:125px;background:url('.get_header_image().') top center no-repeat;border-bottom:0;}';
} 
} 
