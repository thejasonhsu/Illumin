...
<div class="table table_theme">
    <p class="sub"><?php _e('Latest Theme', 'wpzoom'); ?></p>
       ...
       <div class="thumbnail-chrome"><?php
           ...
           ?><?php if ($current) echo $current->data; ?></div>


    <a href="http://www.wpzoom.com/themes/" target="_blank" alt="<?php _e('Browse our wide selection of WordPress themes to find the right one for you', 'wpzoom'); ?>" class="button button-primary"><?php _e('Browse more &rarr;', 'wpzoom'); ?></a>
