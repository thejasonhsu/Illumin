...
if ( ! function_exists( 'evolve_entry_comments' ) ):
	function evolve_entry_comments() {
		...
		comments_popup_link( 'leave a comment', '<span class="comment-count">1</span> comment', '<span class="comment-count">%</span> '.__( 'comments', 'evolve').'', 'commentslink', '<span class="comments-closed">'.__( 'comments closed', 'evolve' ).'</span>' );
