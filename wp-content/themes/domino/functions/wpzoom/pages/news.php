...
<div class="wrap">
    ...
    <ul class="inline">
        <li><a href="http://www.wpzoom.com/themes/"><?php _e('More Themes', 'wpzoom'); ?></a></li>
        <li><a href="http://www.wpzoom.com/support/"><?php _e('Support', 'wpzoom'); ?></a></li>
        <li><a href="http://www.wpzoom.com/category/showcase/"><?php _e('Theme Showcase', 'wpzoom'); ?></a></li>
    </ul>
