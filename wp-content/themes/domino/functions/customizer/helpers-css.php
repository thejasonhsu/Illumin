...
if ( ! class_exists( 'domino_CSS' ) ) :
    ...
    class domino_CSS {
        ...
        /**
         * The one instance of domino_CSS.
         *
         * @var   domino_CSS    The one instance for the singleton.
         */
        ...
        /**
         * Instantiate or return the one domino_CSS instance.
         *
         * @return domino_CSS
         */
        ...
        public function add( $data ) {
             ...
             * @param array    $data    The selectors and properties to add to the CSS.
             */
            $data  = apply_filters( 'domino_css_add', $data );
        ...
        private function parse_declarations( $declarations, $tab = '' ) {
             ...
             * routines are implemented when the developer calls `domino_get_css->add()`. Because every property value has
            ...
            foreach ( $declarations as $property => $value ) {
                 ...
                 */
                $output .= apply_filters( 'domino_parse_declaration', $parsed_value, $property, $value, $t, $n );
            }
             ...
             */
            return apply_filters( 'domino_css_parse_declarations', $output, $declarations, $tab );
        }
    }
endif;

if ( ! function_exists( 'domino_get_css' ) ) :
    /**
     * Return the one domino_CSS object.
     *
     * @return domino_CSS    The one domino_CSS object.
     */
    function domino_get_css() {
        return domino_CSS::instance();
    }
endif;

add_action( 'init', 'domino_get_css', 1 );