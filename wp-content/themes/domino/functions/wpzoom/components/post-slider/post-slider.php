...
class ZOOM_Post_Slider {
    ...
    public function show_metabox( $post, $metabox ) {
        ...
        echo '<div class="slider_btn_add"><a class="wpzoom_slide_add button" href="#">' . __('+ Add Slide', 'wpzoom') . '</a><br class="clear"></div><ul class="wpzoom_slider' . (count($meta) <= 1 ? ' onlyone' : '') . '">';
