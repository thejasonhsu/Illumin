...
if ($evolve_bootstrap_slide_1 == "1") {
      ...
      $evolve_bootstrap_slide1_author = evolve_get_option('evl_bootstrap_slide1_author', 'Bob Loblaw'); if ($evolve_bootstrap_slide1_author === false) $evolve_bootstrap_slide1_author = '';
    ...
    if( (strlen($evolve_bootstrap_slide1_title)>0) || (strlen($evolve_bootstrap_slide1_desc)>0) )
     {
      echo "<div class='carousel-caption' style = 'width: 35%; height: 100%'>";    
      
      if(strlen($evolve_bootstrap_slide1_title)>0) 
      echo "<h2 style = \" font-weight: 700 !important ; padding-top: 25px !important\" >".esc_attr($evolve_bootstrap_slide1_title)."</h2>";

      if(strlen($evolve_bootstrap_slide1_author)>0)   
      echo "<p> Written by: ".esc_attr($evolve_bootstrap_slide1_author)."</p>";
...
if ($evolve_bootstrap_slide_2 == "1") {
      ...
      $evolve_bootstrap_slide2_title = evolve_get_option('evl_bootstrap_slide2_title','Article 2 Title');if ($evolve_bootstrap_slide2_title === false) $evolve_bootstrap_slide2_title = '';   
      $evolve_bootstrap_slide2_desc = evolve_get_option('evl_bootstrap_slide2_desc','Article 2 description');if ($evolve_bootstrap_slide2_desc === false) $evolve_bootstrap_slide2_desc = '';
      $evolve_bootstrap_slide2_author = evolve_get_option('evl_bootstrap_slide2_author', 'Bob Loblaw'); if ($evolve_bootstrap_slide2_author === false) $evolve_bootstrap_slide2_author = '';
      $evolve_bootstrap_slide2_button = evolve_get_option('evl_bootstrap_slide2_button','<a class="button" href="#">Read more</a>');if ($evolve_bootstrap_slide2_button === false) $evolve_bootstrap_slide2_button = '';
    ...
    if( (strlen($evolve_bootstrap_slide2_title)>0) || (strlen($evolve_bootstrap_slide2_desc)>0) )
    {
      ...
      echo "<h2 style = \" font-weight: 700 !important ; padding-top: 25px !important\">".esc_attr($evolve_bootstrap_slide2_title)."</h2>";

      if(strlen($evolve_bootstrap_slide2_author)>0)   
      echo "<p> Written by: ".esc_attr($evolve_bootstrap_slide2_author)."</p>";
...
if ($evolve_bootstrap_slide_3 == "1") {
      ...
      $evolve_bootstrap_slide3_title = evolve_get_option('evl_bootstrap_slide3_title','Article 3 Title');if ($evolve_bootstrap_slide3_title === false) $evolve_bootstrap_slide3_title = '';   
      $evolve_bootstrap_slide3_desc = evolve_get_option('evl_bootstrap_slide3_desc','Article 3 Description');if ($evolve_bootstrap_slide3_desc === false) $evolve_bootstrap_slide3_desc = '';
      $evolve_bootstrap_slide3_author = evolve_get_option('evl_bootstrap_slide3_author', 'Bob Loblaw'); if ($evolve_bootstrap_slide3_author === false) $evolve_bootstrap_slide3_author = '';
      $evolve_bootstrap_slide3_button = evolve_get_option('evl_bootstrap_slide3_button','<a class="button" href="#">Read more</a>');if ($evolve_bootstrap_slide3_button === false) $evolve_bootstrap_slide3_button = '';
    ...
    if( (strlen($evolve_bootstrap_slide3_title)>0) || (strlen($evolve_bootstrap_slide3_desc)>0) )
     {
      ...
      echo "<h2 style = \" font-weight: 700 !important ; padding-top: 25px !important\">".esc_attr($evolve_bootstrap_slide3_title)."</h2>";
  
      if(strlen($evolve_bootstrap_slide3_author)>0)   
      echo "<p> Written by: ".esc_attr($evolve_bootstrap_slide3_author)."</p>";
...
if ($evolve_bootstrap_slide_4 == "1") {
      ...
      $evolve_bootstrap_slide4_title = evolve_get_option('evl_bootstrap_slide4_title','Article 4 Title ');if ($evolve_bootstrap_slide4_title === false) $evolve_bootstrap_slide4_title = '';   
      $evolve_bootstrap_slide4_desc = evolve_get_option('evl_bootstrap_slide4_desc','Article 4 Description');if ($evolve_bootstrap_slide4_desc === false) $evolve_bootstrap_slide4_desc = '';
      $evolve_bootstrap_slide4_author = evolve_get_option('evl_bootstrap_slide4_author', 'Bob Loblaw'); if ($evolve_bootstrap_slide4_author === false) $evolve_bootstrap_slide4_author = '';
      $evolve_bootstrap_slide4_button = evolve_get_option('evl_bootstrap_slide4_button','<a class="button" href="#">Read more</a>');if ($evolve_bootstrap_slide4_button === false) $evolve_bootstrap_slide4_button = '';
      ...
      if( (strlen($evolve_bootstrap_slide4_title)>0) || (strlen($evolve_bootstrap_slide4_desc)>0) )
     {
      ...
      echo "<h2 style = \" font-weight: 700 !important ; padding-top: 25px !important\">".esc_attr($evolve_bootstrap_slide4_title)."</h2>";

      if(strlen($evolve_bootstrap_slide4_author)>0)   
      echo "<p> Written by: ".esc_attr($evolve_bootstrap_slide4_author)."</p>";
...
if ($evolve_bootstrap_slide_5 == "1") {
      ...
      $evolve_bootstrap_slide5_title = evolve_get_option('evl_bootstrap_slide5_title','Article 5 Title');if ($evolve_bootstrap_slide5_title === false) $evolve_bootstrap_slide5_title = '';   
      $evolve_bootstrap_slide5_desc = evolve_get_option('evl_bootstrap_slide5_desc','Article 5 Description');if ($evolve_bootstrap_slide5_desc === false) $evolve_bootstrap_slide5_desc = '';
      $evolve_bootstrap_slide5_author = evolve_get_option('evl_bootstrap_slide5_author', 'Bob Loblaw'); if ($evolve_bootstrap_slide5_author === false) $evolve_bootstrap_slide5_author = '';
      $evolve_bootstrap_slide5_button = evolve_get_option('evl_bootstrap_slide5_button','<a class="button" href="#">Read more</a>');if ($evolve_bootstrap_slide5_button === false) $evolve_bootstrap_slide5_button = '';
      ...
      if( (strlen($evolve_bootstrap_slide5_title)>0) || (strlen($evolve_bootstrap_slide5_desc)>0) )
     {
      ...
      echo "<h2 style = \" font-weight: 700 !important ; padding-top: 25px !important\">".esc_attr($evolve_bootstrap_slide5_title)."</h2>";

      if(strlen($evolve_bootstrap_slide5_author)>0)   
      echo "<p> Written by: ".esc_attr($evolve_bootstrap_slide5_author)."</p>";

      if(strlen($evolve_bootstrap_slide5_desc)>0) 
      echo "<p style = 'font-weight: 300 !important'>".esc_attr($evolve_bootstrap_slide5_desc)."</p>";
