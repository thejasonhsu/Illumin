...
<head>
  ...
  <!--<link rel="stylesheet" type="text/css" href="//cloud.typography.com/6510154/726346/css/fonts.css" />-->
	<?php } ?>
  ...
  <?php } else { ?>
   ...
   <?php $evolve_header_logo = evolve_get_option('evl_header_logo', '');
    if ($evolve_header_logo) {
        ...
        $uscurl = get_template_directory_uri() . "/library/media/images/usc-logo-image.png";
        echo "<a class='img-responsive' href= 'http://www.usc.edu'><img id = 'usc-logo-image' src =".$uscurl. " style = 'float:right; max-width: 300px; margin-top:20px; margin-right:0;'> </a>";
    }
      ?>   
